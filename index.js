 ...
 * sails-hook-mongoat
 *
 * A hook for Sails.js providing advanced Mongo indexing options for models making use of
 * the `sails-mongo` adapter. Supports Sails v1 and v0.12.
 *
 * Originally created by Mike Diarmid (https://github.com/Salakar) on 26-05-2015.
 * Fork maintained by Floatplane Media (https://github.com/fpm-git).
 */
